...
Welcome to the contributor guide of ASM1 Influent Generator.
...
If you experience bugs or general issues with ASM1 Influent Generator, please have a look
...
You can help improve the documentation of ASM1 Influent Generator by making them more readable
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:YourLogin/asm1-influent-generator.git
   cd asm1-influent-generator
   ```
